...
////    val indexD: ArrayList<Int> = arrayListOf(1, 2, 3, 4, 5, 6, 7, 8, 9)
...
////            indexA = ArrayList(possibleSolutions.map { it.first }.distinct().sorted())
////            println(possibleSolutions.map { it.first }.distinct().sorted())
////            println("Возможные значения для B:")
////
////            indexB = ArrayList(possibleSolutions.map { it.second }.distinct().sorted())
////            println(possibleSolutions.map { it.second }.distinct().sorted())
////            println("Возможные значения для C:")
////
////            indexC = ArrayList(possibleSolutions.map { it.third }.distinct().sorted())
...
//import kotlin.collections.ArrayList
//
//// Объявление переменных на уровне верхнего уровня
//val indexA: ArrayList<Int> = ArrayList()
//val indexB: ArrayList<Int> = ArrayList()
//val indexC: ArrayList<Int> = ArrayList()
//val indexD: ArrayList<Int> = ArrayList()
//
//fun main() {
//    val numberOfCardsOnTheTable = 1
//    val questionFullList: MutableMap<Int, String> =
//        mutableMapOf(
//            1 to "Какова сумма чисел на трех ваших левых жетонах",
//            // Добавьте остальные вопросы по мере необходимости
//        )
//    val mapa: MutableMap<String, Int> =
//        mutableMapOf(
//            "0b" to 0,
...
//            "9w" to 9
//        )
//    val player1: ArrayList<String> = ArrayList()
//    val player2: ArrayList<String> = ArrayList()
//    val player3: ArrayList<String> = ArrayList()
//    val player4: ArrayList<String> = ArrayList()
//    val playerKOD: ArrayList<String> = ArrayList()
//
//    val listOfKeys: MutableList<String> = mutableListOf()
//    for (i in mapa.keys) {
//        listOfKeys.add(i)
